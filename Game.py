...
while playerin or dealerin:
    print(f"The dealer has {value(dealercards)} from {showdealercards()}
and ?")
...
if value(playercards) == 21:
    print(f"You have {playercards} for {value(playercards)} and the dealer
has {dealercards} for {value(dealercards)}")
    print("YOU WIN!")
elif value(dealercards) == 21:
    print(f"You have {playercards} for {value(playercards)} and the dealer
has {dealercards} for {value(dealercards)}")
